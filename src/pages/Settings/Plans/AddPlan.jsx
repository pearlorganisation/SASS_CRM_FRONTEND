...
import { addPricePlans } from '../../../features/actions/pricePlan'
...
export default function AddPlan() {
  ...
  const { isLoading, planData, isSuccess } = useSelector(state => state.pricePlans)
    ...
    <div className='grid place-items-center min-h-screen'>
      <div className="max-w-2xl mx-auto w-full bg-white shadow-md rounded-lg overflow-hidden">
        <div className="px-6 py-4 bg-gray-50 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-800">Add Price Plan</h2>
          <p className="mt-1 text-sm text-gray-600">Create a new pricing plan for your service</p>
        </div>
