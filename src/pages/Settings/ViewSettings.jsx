...
const ViewSettings = () => {
  ...
  return (
    <div className='mt-10 text-center'>
     ...
     {roles.SUPER_ADMIN === role &&   <Link to='/sidebarLinks' className='flex items-center justify-center gap-10 font-bold text-xl rounded-lg bg-white h-20 w-56 cursor-pointer hover:bg-blue-600 hover:text-white text-blue-600'><PiLinkSimpleBold size={40}/> Sidebar links</Link>}
